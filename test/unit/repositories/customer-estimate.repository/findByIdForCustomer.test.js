...
describe('CustomerEstimateRepository.findByIdForCustomer', () => {
  it('scopes the lookup by both id and customerId, and includes line items, address, and customer scoped to the same tenant schema', async () => {
      ...
      include: [
        {
          ...
          as: 'items',
          include: [{ model: scopedTaxRateModel }, { model: scopedItemDefModel }],
        },
