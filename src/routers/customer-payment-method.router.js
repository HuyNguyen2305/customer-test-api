...
} from '#schemas/customer-payment-method.schema.js';
...
export default async function customerPaymentMethodRouter(fastify, opts) {
  ...
  fastify.post('/customer/payment-methods', { schema: createPaymentMethodSchema }, (request, reply) =>
    controller.addPaymentMethod(request, reply),
  );
